...
- [x] **T006** `IGameResultClient` 인터페이스 + Mock 구현 — 결과 보고 경계
...
- [x] **T010** 게임 부스 진입·시작 처리 — 서버에서 목표 시간(5~10초) 발급받기
- [x] **T011** 타이머 UI + 정지 입력 처리
- [x] **T012** 오차 산출·표시 + 결과 보고 (Mock 클라이언트 기준 — 실서버 계약은 T008·-294) (목표/정지/오차)
