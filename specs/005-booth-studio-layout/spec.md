...
| 대상 | 지적 |
|---|---|
| FR-002 (템플릿) | `template`은 문자열 저장 + 화이트리스트 검증까지만 — 템플릿의 실체는 C-06(1종 `PROJECT_EXHIBITION`, 셸 1:1)이 정의하며 미리 배치되는 오브젝트는 없다 |
...
> **FE·BE 검토 완료** (2026-08-14 / 2026-08-20). 현재 확정 상태는 위 Clarifications 표가 정본이다.
