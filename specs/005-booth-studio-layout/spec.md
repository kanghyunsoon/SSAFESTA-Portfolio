...
| ~~C-05~~ | ~~Owner와 Staff의 동시 편집 정책은?~~ | — | ✅ **확정: `version` 낙관적 잠금 + 409.** BE 채택([Issue #5](https://github.com/kanghyunsoon/ssafesta/issues/5), 2026-08-20). 요청 스키마 `version` 위치·409 응답 body 형식은 BE 착수 시 확정 |
...
**BE 검토**: __________ / **검토일**: __________
