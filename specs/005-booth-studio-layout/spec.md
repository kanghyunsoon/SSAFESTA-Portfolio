...
| 구분 | 내용 |
|---|---|
| ② SC-002 | `[NEEDS CLARIFICATION: 목표 수치]`에 대응하는 C-xx가 없어 담당·기한이 지정되지 않는다. 006 C-01이 정한 것은 갱신 트리거이지 시간 목표가 아니다 |
...
> **FE분 1차 검토 완료.** ①은 의견이며 확정이 아니다. BE 검토 + C-03~C-07 결정 후 `/speckit-plan` 진행 가능.
