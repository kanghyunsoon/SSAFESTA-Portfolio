...
- [ ] **`!93` 추적** — `-315` spec 016 정합. 리뷰어 ejraks1548, `Closes S15P21A604-315`. `#110`·`#115` 회신은 08-28 게시 완료(note 2752699·2752700)이며 **FE 잔여 0건**이다 — `#115` 의 `spec.md` 3건과 §3 한 줄은 리드 문서다
