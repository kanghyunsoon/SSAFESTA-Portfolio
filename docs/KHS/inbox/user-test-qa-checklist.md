...
| 3 | 월드 진입 시간 | Game·FE·Infra | 로비 클릭 → 게이트 개방 **10초 내**(로컬 3.0s). FE 로딩 안내(`onWorldLoadStart`) 표시 | 09-06 dev #6 3.0s ✅ | | |
...
| GitLab | 테스트용 AI configId·GAME_PORTAL 바인딩·PROJECT_PANEL 게시 (AI·FE·BE) | 없으면 상담·게임 단계가 토스트로 끝난다 | 이슈 발행 |
