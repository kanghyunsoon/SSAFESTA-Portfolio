...
| 10 | 부스 내부 v3 | 포털 F 입장 → 스폰 시점 / 문 앞 / AI 도우미 앞 | 6 m 셸이 방을 채우고 어둡지 않음(휘도 0.4 대), 입장 직후 부스를 바라봄, 문틀·EXIT 사인(글자 정방향)·매트, "나가기" 프롬프트는 문 앞에서만, AI 도우미 캐릭터+이름표(0.6 m 크기), 노트북 F 하이라이트가 노트북에만 | -445 |
