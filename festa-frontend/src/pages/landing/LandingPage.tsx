...
// 화면 어디를 눌러도 진행한다. 목적지는 직접 정하지 않고 기존 가드에 위임한다 —
// /app/home 으로 보내면 RequireAuth 가 비로그인은 /login(returnTo 저장)으로, 로그인은 홈으로 보낸다.
...
export function LandingPage() {
  ...
  return (
    <button type="button" className="landing-root" onClick={() => navigate('/app/home')} aria-label="화면을 클릭해 시작하기">
